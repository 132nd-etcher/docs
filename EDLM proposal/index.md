...
The proposal is about documentation in the //wing. I would like to explore 
...
the Github repository of the //wing**.
...
for the //696 (for example), which contains all media relevant to the 
//696 and is accessible to all documents of the //696. And, finally, 
...
of the //wing, updating that picture in each one of them **in a 
...
GRG made by Looney (respect, sir) into the //617 TRP. We drop 
...
Now let's take the example above a tad further. Imagine the //765 
...
![Basic work flow \label{basic_workflow}](image1.png)
...
published by the //wing would be automated as well, 
