...
* Uniformly formatted: **all** the documents in the library should have the same general layout, giving all documentation published by the 132^nd^ Virtual Wing a visual identity of their own
...
![Mardown logo](https://i.imgur.com/ZGkIYsr.png)
