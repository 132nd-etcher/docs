...
Once the mod is ready, using //ovgme, the source folder is packaged into a ZIP file, along with "metadata" about (metadata is things like version, description, author, etc.).
